...
import com.LUT_Operations.GenerateHex;
...
public class index extends javax.swing.JFrame {
    ...
    private boolean isDataSentToCloud = true;
    ...
    public index() {
        ...
        // Connect to HiveMQ in background as soon as app opens
        new Thread(() -> EnDocMqttPublisher.connect()).start();
    ...
    private void initComponents() {
        ...
        btnGenerateHex = new javax.swing.JButton();
        ...
        btnGenerateHex.setBackground(new java.awt.Color(255, 255, 255));
        btnGenerateHex.setText("Generate Hex");
        btnGenerateHex.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnGenerateHexActionPerformed(evt);
            }
        });
                    ...
                    if (lutName1.getText().equals("LUT")) {
                        ...
                        if (txtCalID.getText().equals("")) {
                            ...
                            try {
                                ...
                                //PRODUCTION MONITOR CODE GOES HERE: 
                               // if (lbl_Functionality_Test.getText().trim().equals("Functionality Okay")) 
                                ...
                                // if (beforeRowCount == afterRowCount)
                                {
                                    ...
                                    if (flashCount < 9) {
                                      ...
                                      // -------------------------------------------------------------
                                                        // MQTT SEND LOGIC: Sends ONLY ONCE per successful pass
                                                        // -------------------------------------------------------------
                                                        //if (!isDataSentToCloud) 
                                                        {
                                                            System.out.println("Calling MQTT Service");
                                                            java.util.Map<String, Object> payloadMap = new java.util.HashMap<>();
                                                            payloadMap.put("sessionCount", sessionCount.getText());
...
// TODO add your handling code here:
    ...
    private void btnGenerateHexActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerateHexActionPerformed
        // TODO add your handling code here:
        ...
        GenerateHex hexGen = new GenerateHex();
        hexGen.genHex(table_DOI, table_EGR, EGR_SUM, table_Temperature, table_Prerssure, txtCalID.getText(), table_ExhaustTemperature, table_DeltaPrerssure, Engine_Params, Diagnostics_Table);

    }//GEN-LAST:event_btnGenerateHexActionPerformed
    ...
    private javax.swing.JButton btnGenerateHex;
